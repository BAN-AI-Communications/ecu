...
/*+-------------------------------------------------------------------------
	template.c - DCE-specific portion of generic SCO UUCP dialer
	wht@wht.net

 Necessary DCE switch setting or other configuration:
   Switch foo off: enable onhook upon loss of DTR
--------------------------------------------------------------------------*/
/*+:EDITS:*/
 ...
 */
long DCE_write_pace_msec = 20;

/*
 * DCE_name     - short name for DCE
 * DCE_revision - revision number for this module
 */
char *DCE_name = "Frobozz 9600";
char *DCE_revision = "1.10";
...
/* issue the actual dialing command */
